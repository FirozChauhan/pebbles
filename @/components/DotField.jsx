...
const DotField = memo(({
  ...
  useEffect(() => {
    ...
    function onTouchMove(e) {
      ...
      if (!t) return;
      mouseRef.current.x = t.pageX - s.offsetX;
      mouseRef.current.y = t.pageY - s.offsetY;
    }
    ...
    window.addEventListener('touchend', resetCursor, { passive: true });
    window.addEventListener('touchcancel', resetCursor, { passive: true });
    rafRef.current = requestAnimationFrame(tick);
